package com.elderxavier.pontointeligente.api.config;
...
//import com.elderxavier.pontointeligente.api.security.utils.JwtTokenUtil;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.elderxavier.pontointeligente.api.controllers"))
